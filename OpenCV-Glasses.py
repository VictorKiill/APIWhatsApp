...
#inport sys because yes(precisa para a barra de progresso)
import sys
...
def calcula_acur():
    ...
    #Variavel contador do número de acertos
    cont_acertos = 0
    ...
    for i, dir_name in enumerate(dirs, 1):
       ...
       # get the images names that are inside the given subject directory
        ...
        print("Pasta: " +str(i)+ "/", str(len(dirs)))

        # go through each image name, read image
        # Prevê os resultados e avalia se acertou ou errou
        for i2, image_name in enumerate(subject_images_names, 1):
            ...
            #Progresso
            progress(i2, len(subject_images_names))
